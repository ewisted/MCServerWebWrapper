...
//
//    var officialVersion = OfficialVersion.FromJson(jsonString);
//
// I <3 you quicktype.io

namespace MCServerWebWrapper.Server.Models
{
	public partial class OfficialVersion
	{
		...
		public OfficialVersionDownloads Downloads { get; set; }
	...
	{
		[JsonProperty("game")]
		public List<GameElement> Game { get; set; }

		[JsonProperty("jvm")]
		public List<JvmElement> Jvm { get; set; }
	}
	...
	{
		[JsonProperty("rules")]
		public List<JvmRule> Rules { get; set; }
	...
	public partial class OfficialVersionDownloads
	{
		[JsonProperty("client")]
		public ClientMappingsClass Client { get; set; }

		[JsonProperty("client_mappings")]
		public ClientMappingsClass ClientMappings { get; set; }

		[JsonProperty("server")]
		public ClientMappingsClass Server { get; set; }

		[JsonProperty("server_mappings")]
		public ClientMappingsClass ServerMappings { get; set; }
	}

	public partial class ClientMappingsClass
	{
		[JsonProperty("sha1")]
		public string Sha1 { get; set; }
	...
	public partial class LibraryDownloads
	{
		...
		public ClientMappingsClass Artifact { get; set; }
	...
	public partial class OfficialVersion
	{
		public static OfficialVersion FromJson(string json) => JsonConvert.DeserializeObject<OfficialVersion>(json, MCServerWebWrapper.Server.Models.Converter.Settings);
	}

	public static class Serialize
	{
		public static string ToJson(this OfficialVersion self) => JsonConvert.SerializeObject(self, MCServerWebWrapper.Server.Models.Converter.Settings);
	}
